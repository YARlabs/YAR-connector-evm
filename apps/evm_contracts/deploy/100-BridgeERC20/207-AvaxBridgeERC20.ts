...
const deploy: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const currentChain = EthersUtils.keccak256('AVAX')
...
deploy.tags = ['AvaxBridge', 'AvaxBridgeERC20']
