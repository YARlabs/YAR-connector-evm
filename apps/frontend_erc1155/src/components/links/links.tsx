  ...
  return (
    <>
        ...
        <h5 className="text-center">
            ...
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
            <a
              href={`${CHAINS_CONFIG.optimismTest.explorer}/address/${BRIDGES_ADDRESSES.erc1155.optimismTest}`}
              target="_blank"
              rel="noreferrer"
            >
              in Optimism
            ...
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
            <a
              href={`${CHAINS_CONFIG.arbitrumTest.explorer}/address/${BRIDGES_ADDRESSES.erc1155.arbitrumTest}`}
              target="_blank"
              rel="noreferrer"
            >
              in Arbitrum
            ...
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
            <a
              href={`${CHAINS_CONFIG.avaxTest.explorer}/address/${BRIDGES_ADDRESSES.erc1155.avaxTest}`}
              target="_blank"
              rel="noreferrer"
            >
              in Avalanche
            ...
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
            <a
              href={`${CHAINS_CONFIG.baseTest.explorer}/address/${BRIDGES_ADDRESSES.erc1155.baseTest}`}
              target="_blank"
              rel="noreferrer"
            >
              in BASE
