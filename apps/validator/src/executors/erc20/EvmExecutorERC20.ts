...
import { ITransferModelERC20 } from '../../models/erc20/TransferModelERC20'
...
export class EvmExecutorERC20 {
  ...
  private async _executeTrasfers(trasfers: Array<ITransferModelERC20>) {
  ...
  private async _tarsferFromOtherChain(transfer: ITransferModelERC20) {
