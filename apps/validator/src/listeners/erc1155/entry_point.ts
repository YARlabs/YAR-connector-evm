...
import { EvmListenerERC1155 } from './EvmListenerERC1155'
...
async function main() {
  ...
  const db = new DataBase({ dbName: 'ERC1155', processName: `${CHAIN_NAME} EvmListener` })
  ...
  try {
    ...
    const listener = new EvmListenerERC1155({
      name,
      bridgeAddress,
      numberOfBlocksToConfirm,
      providerUrls,
