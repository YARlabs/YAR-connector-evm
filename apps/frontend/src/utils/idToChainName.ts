...
export const idToBridgeAddress = {
    [CHAINS_CONFIG.binanceTest.chainId]: BRIDGES_ADDRESSES.erc20.binanceTest,
    [CHAINS_CONFIG.ethereumTest.chainId]: BRIDGES_ADDRESSES.erc20.ethereumTest,
    [CHAINS_CONFIG.polygonTest.chainId]: BRIDGES_ADDRESSES.erc20.polygonTest,
    [CHAINS_CONFIG.yarTest.chainId]: BRIDGES_ADDRESSES.erc20.yarTest,
    [CHAINS_CONFIG.chaosSkaleTest.chainId]: BRIDGES_ADDRESSES.erc20.chaosSkaleTest,
    [CHAINS_CONFIG.optimismTest.chainId]: BRIDGES_ADDRESSES.erc20.optimismTest,
    [CHAINS_CONFIG.arbitrumTest.chainId]: BRIDGES_ADDRESSES.erc20.arbitrumTest,
    [CHAINS_CONFIG.avaxTest.chainId]: BRIDGES_ADDRESSES.erc20.avaxTest,
    [CHAINS_CONFIG.baseTest.chainId]: BRIDGES_ADDRESSES.erc20.baseTest,
}
