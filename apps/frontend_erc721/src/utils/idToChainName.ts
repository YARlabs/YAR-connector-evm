...
export const idToBridgeAddress = {
    [BSCTestnet.chainId]: BRIDGES_ADDRESSES.erc721.binanceTest,
    [Goerli.chainId]: BRIDGES_ADDRESSES.erc721.ethereumTest,
    [Mumbai.chainId]: BRIDGES_ADDRESSES.erc721.polygonTest,
    [customIds.yar]: BRIDGES_ADDRESSES.erc721.yarTest,
    [customIds.skale]: BRIDGES_ADDRESSES.erc721.chaosSkaleTest
}
