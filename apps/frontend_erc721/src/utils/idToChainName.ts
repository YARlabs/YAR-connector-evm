...
export const idToBridgeAddress = {
    [CHAINS_CONFIG.binanceTest.chainId]: BRIDGES_ADDRESSES.erc721.binanceTest,
    [CHAINS_CONFIG.ethereumTest.chainId]: BRIDGES_ADDRESSES.erc721.ethereumTest,
    [CHAINS_CONFIG.polygonTest.chainId]: BRIDGES_ADDRESSES.erc721.polygonTest,
    [CHAINS_CONFIG.yarTest.chainId]: BRIDGES_ADDRESSES.erc721.yarTest,
    [CHAINS_CONFIG.chaosSkaleTest.chainId]: BRIDGES_ADDRESSES.erc721.chaosSkaleTest,
    [CHAINS_CONFIG.optimismTest.chainId]: BRIDGES_ADDRESSES.erc721.optimismTest,
    [CHAINS_CONFIG.arbitrumTest.chainId]: BRIDGES_ADDRESSES.erc721.arbitrumTest,
    [CHAINS_CONFIG.avaxTest.chainId]: BRIDGES_ADDRESSES.erc721.avaxTest,
    [CHAINS_CONFIG.baseTest.chainId]: BRIDGES_ADDRESSES.erc721.baseTest,
}
